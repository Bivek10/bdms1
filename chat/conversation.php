...
?>
		...
		<table class="" width="100%">
			<tr>
				<td width="10%"><div class="uavatar"><img src="assets/uploads/personimg.png" alt=""></div></td>
...
<div id="convo_clone" style="display: none">
	<div class="convo">
	<div class="img"><img src="assets/uploads/personimg.png" alt=""></div>
...
<script>
	...
	$('#send_chat').submit(function(e){
		...
		if($('[name="message"]').val() == '')
			return false;
			var data = {name:'<?php echo $_SESSION['login_name'] ?>',id:'<?php echo $_SESSION['login_id'] ?>',avatar:'personimg.png',message:$('[name="message"]').val()}
	...
	window.chat_box=function(data,count,loaded =0){
		...
		cfield.find('img').attr('src','assets/uploads/personimg.png')
		cfield.find('img').attr('src','assets/uploads/personimg.png')

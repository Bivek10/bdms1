...
<body style="background-image:url('admin_image/back.jpg'); background-repeat: no-repeat; background-size: cover;">
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF'];?>" method="post">
    ...
    <div class="container"  style="margin-top:150px; width:600px; ">
      <div class="row justify-content-center">
          <div class="col-lg-4">
              <h1 class="mt-4 mb-3" style="color:#B51212 ;">
                  LogIn
                </h1>

            </div>
      </div>
      <div class="card" style="height:350px; background-image:url('admin_image/glossy1.jpg');">
          <div class="card-body">
